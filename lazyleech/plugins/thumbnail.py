...
from .. import ALL_CHATS, help_dict, BOT_UNAME
from ..utils.misc import convert_to_jpg, get_file_mimetype, watermark_photo

@Client.on_message(filters.command(['savethumb',f'savethumb@{BOT_UNAME}']) & filters.chat(ALL_CHATS))
...
@Client.on_message(filters.command(['clearthumb', f'clearthumb@{BOT_UNAME}']) & filters.chat(ALL_CHATS))
...
'''/savethumb <i>&lt;as reply to image or as a caption&gt;</i>
